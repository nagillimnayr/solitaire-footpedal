...
public abstract class AbstractSerialThread
{
    ...
    public void RunForever()
    {
        ...
        try
        {
            while (!IsStopRequested())
            {
                ...
                catch (Exception ioe)
                {
                    ...
                    /* Ryan: Added this line to prevent it constantly throwing errors when we try a port
        ...
        catch (Exception e)
        {
            ...
            /* Ryan: Added this to prevent it constantly throwing errors when a Com Port isn't being used. */
            RequestStop();
        }
    }
    ...
    private void RunOnce()
    {
        try
        {
            ...
            if (inputMessage != null)
            {
                ...
                {
                    // remove item from front of queue and push new item into back
                    inputQueue.Dequeue();
                    inputQueue.Enqueue(inputMessage);
